...
public class LoanService {
    ...
    public DTO.TransactionResponse disburseLoan(String loanAccountId, String cashAccountId,
                                                BigDecimal principal, BigDecimal fee,
    ...
    public DTO.TransactionResponse recordRepayment(String cashAccountId, String loanAccountId,
    ...
    public DTO.TransactionResponse writeOffLoan(String loanAccountId, String badDebtExpenseAccountId,
        ...
        DTO.TransactionRequest writeOffRequest = new DTO.TransactionRequest(
